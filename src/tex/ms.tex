...
\begin{abstract}
\te{There is still a "KW:fill" remaining in the text!}
...
distribution \citep{}\te{There is apparently supposed to be a citation here?}.
...
\begin{figure*}
    ...
    \caption{
      GW150914 posterior computed by our code (blue) and \textsc{Bilby} (orange). \te{Change font to be latex, make labels larger, make figure full page.}
    }
    \label{fig:GW150914}
...
\caption{
    GW170817 posterior computed by our code (blue) and \textsc{Bilby} (orange). \te{Same as Fig 2}
}
\label{fig:GW170817}
...
in the configurations files included in our data release \citep{release} \te{Add citation}.  We
