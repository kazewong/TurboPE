...
In order to verify the fidelity of the sampler, we can inject a signal
into the parameter estimation pipeline and compared the recovery parameters to
the true parameters. 
...
Our implemneted the following major features to achieve its performance:
\begin{enumerate}
