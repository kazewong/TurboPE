...
coefficients of computed using the data and the reference waveform, and
$r_0(h,b)$ and $r_1(h,b)$ are the ratio between the target waveform and the
...
evaluate the coefficients given the data and the reference waveform, and finally
evaluate the ratio between the target waveform and the reference waveform at the
center of the bin.
...
% Interplay with importance sampling
