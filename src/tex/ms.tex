...
reduced-order quadrature \cite{Canizares:2014fya,Smith:2016qas}, adaptive proposal distributions in nested sampling
...
(NR) simulations \cite{BaumgarteShaprio:NumRel}, which directly solve the Einstein equations numerically for a
...
\cite{Field:2011mf, Field:2013cfa, Smith:2016qas,
Vinciguerra:2017ngf,Morisaki:2020oqk,Morisaki:2021ngj}. In this work, we take
advantage of likelihood heterodyning \cite{Cornish:2010kf,Cornish:2021lje}
(also known as relative binning \cite{Zackay:2018qdy}).
...
Hamiltonian Monte Carlo \cite{2017arXiv170102434B} is another gradient-based
algorithm that has been explored for neutron star inspirals
\cite{Bouffanais:2018hoz}.
...
GWOSC \cite{GWOSC}. We use the same normalizing flow model as the
...
placement and calibrating waveforms to numerical relativity \cite{Coogan:2022qxs,Iacovelli:2022bbs,Iacovelli:2022mbg,ripplepaper}.
...
and phase \cite{2019PASA...36...10T}. As the performance of our implementation is not
