...
\begin{table*}[hbt!]
    ...
    $q$ & mass ratio & $[0.5, 1]$\\
    $\chi_1$ & dimensionless spin of the primary mass & $[-0.5, 0.5]$\\
    $\chi_2$ & dimensionless spin of the secondary mass & $[-0.5, 0.5]$\\
    $d_L$ & luminosity distance & $[300, 2000] Mpc$\\
    $t_c$ & coalescence time & $[-0.5, 0.5] s$\\
...
\begin{figure}
    ...
    \caption{Result of 1000 injections drawn from the 16 seconds prior.}
    \label{fig:ppplot}
    \end{figure}
