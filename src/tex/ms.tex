...
\textsc{scipy} package \cite{2020SciPy-NMeth} to find the waveform parameters which maximize the
likelihood.
\mi{The reference waveform could also be produced from trigger parameters
precomputed by a search pipeline without additional computation.}
