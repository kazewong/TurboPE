...
events like GW150914 and GW170817 within a minute of sampling time with little to
...
problems. We also discuss as near real-time parameter estimation has been shown
...
the most recent catalog of GW events are powered by several community-developed
PE codes, including \texttt{lalinference}, \texttt{pycbc}, and \texttt{bilby}
\cite{Romero-Shaw:2020owr} \kw{cite}. These packages have been tested by a
number of groups and are well regarded as the standard tools.
...
\KwData{Initial position}
\KwResult{Chains, $\log{\mathcal{L}}$}
\emph{Training}\;
% \While{not converged}{
%     \For{n_loc}{
